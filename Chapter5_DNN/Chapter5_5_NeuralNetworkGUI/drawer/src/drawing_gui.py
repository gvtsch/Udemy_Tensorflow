...
class Painter(QtWidgets.QWidget):
    ...
    def mouseMoveEvent(self, event=None):
        if self.ParentLink.IsPainting is True:  # type: ignore
...
class CreateUI(BASE, FORM):  # type: ignore
    ...
    def PredictNumber(self):
        ...
        image_file_path = os.path.join(IMAGE_DIR, str(y_pred_class_idx) + ".png") # str concatenate mit int -> string typecast
